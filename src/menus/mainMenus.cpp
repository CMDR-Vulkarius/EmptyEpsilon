...
MainMenu::MainMenu()
{
    ...
    (new GuiLabel(this, "VERSION", tr("Credits", "Version: {version}").format({{"version", VERSION_STRING}}), 20))->setPosition(0, title_y + logo_size, sp::Alignment::TopCenter)->setSize(0, 20);
